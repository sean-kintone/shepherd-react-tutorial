        ...
        describe("with file path", function () {
            ...
            it("should pass file object includes name and data as a param to the http client", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            (0, platform_1.injectPlatformDeps)(__assign(__assign({}, nodeDeps), { readFileFromPath: function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        return [2 /*return*/, ({
                                                name: filePath,
                                                data: "Hello!",
...
describe("FileClient with guestSpaceId", function () {
    ...
    it("should pass the path to the http client", function () {
        expect(mockClient.getLogs()[0].path).toBe("/k/guest/".concat(GUEST_SPACE_ID, "/v1/file.json"));
    });
});
